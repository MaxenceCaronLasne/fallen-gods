...
*** TODO [#A] Tests and fixes
**** TODO [#A] Vérifier si le compteur overflow (bloquer le ramassage si plein ?)
**** TODO [#A] Vérifier si on peut acheter des niveaux max overflow
