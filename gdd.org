...
*** TODO Personnage
**** TODO Déplacement (input) :PROG:
**** TODO Saut (input) :PROG:
**** TODO Sprite :ASSET:
***** TODO Animation Idle :ASSET:
***** TODO Animation Course :ASSET:
***** TODO Animation Saut :ASSET:
***** TODO Animation Double-Saut :ASSET:
***** TODO Implementation Animation :PROG:
***** TODO Anim dynamique :PROG:
**** TODO SFX :ASSET:
***** TODO Implementation SFX :PROG:

*** TODO Projectiles
**** TODO Déplacement :PROG:
**** TODO Rebond :PROG:
**** TODO Apparition/Destruction :PROG:
**** TODO Sprite :ASSET:
**** TODO Animation :PROG:
***** TODO Transformations/modifications dynamiques :PROG:
***** TODO Pulsation :PROG:
***** TODO Destruction (particules ?) :PROG:
***** TODO SFX implementation :PROG:
**** TODO SFX :ASSET:
**** TODO Patterns de spawn simple :PROG:

*** TODO Interaction personnage-projectile
**** TODO Toucher un projectile
***** TODO Animation Game Over
****** TODO Personnage Destruction :ASSET:PROG:
****** TODO Reset du level :PROG:
***** TODO Implementation :PROG:
**** TODO Sauter au-dessus d'un projectile
***** TODO Animation Saut :ASSET:PROG:
***** TODO SFX :ASSET:
***** TODO Compteur :ASSET:PROG:

*** TODO Interface
**** TODO Background :ASSET:
**** TODO Reset du niveau :PROG:
