...
*** TODO [#A] Magasin
**** TODO [#A] Interface :PROG:ASSET:
***** TODO [#A] Buy more lives button
***** TODO [#A] Buy more jumps button
***** TODO [#A] Curseur
***** TODO [#A] Selectionner les boutons avec les directions
**** TODO [#A] Acheter élément :PROG:
***** TODO [#A] Valider un élément
***** TODO [#A] Appliquer l'upgrade

*** TODO [#A] Inventaire
**** KILL [#A] Équiper/Déséquiper :PROG:
**** TODO [#A] Interface :ASSET:PROG:

*** TODO [#A] Vies supplémentaires :PROG:
**** TODO [#B] Avantage à jouer avec moins de PV :PROG:
**** TODO [#A] Implem vies variables :PROG:
***** TODO [#A] Dans le code :PROG:
***** TODO [#A] Dans l'interface :PROG:

*** TODO [#A] Smart bomb :PROG:ASSET:
**** TODO [#B] Activable manuellement ou lors d'une touche ? :ASK:

*** TODO [#B] Saut supplémentaires :PROG:
**** TODO [#B] Avantage à jouer avec moins de sauts :PROG:
