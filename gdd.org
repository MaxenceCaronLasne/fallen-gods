...
**** DONE Sprite :ASSET:
**** TODO Animation :PROG:
***** PROJ Transformations/modifications dynamiques :PROG:
***** PROJ Pulsation :PROG:
***** PROJ Destruction (particules ?) :PROG:
****** PROJ Screen shake :PROG:
