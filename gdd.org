...
** TODO Milestone 4 : premiers playtests

*** TODO [#A] Equilibrage :PROG:
**** TODO [#A] Equilibrer le prix des upgrades :PROG:
***** TODO [#A] Rendre les prix différents pour chaque palier :PROG:

*** TODO [#A] Bugs
**** TODO [#A] Init des items du magasin
Les items du magasin ne sont pas init avec les valeurs courantes des niveaux des
upgrades.

*** TODO [#A] Interface :ASSET:PROG:
**** TODO [#A] Afficher le prix des upgrades

** TODO Milestone 5 : la réunification, polish et art
...
*** TODO [#A] Polish
**** TODO [#A] Pluie en background, pour plus de dynamisme.
